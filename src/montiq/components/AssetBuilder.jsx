                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="flex items-center bg-white dark:bg-black/20 px-3 py-1 rounded-lg border border-slate-200 dark:border-white/5">
                          <input 
                              ...
                              onChange={(e) => updateAlloc('equity', e.target.value)} 
                              className="w-10 bg-transparent outline-none text-right font-black text-brand-purple placeholder-slate-400" 
                          />
                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="flex items-center bg-white dark:bg-black/20 px-3 py-1 rounded-lg border border-slate-200 dark:border-white/5">
                          <input 
                              ...
                              onChange={(e) => updateAlloc('debt', e.target.value)} 
                              className="w-10 bg-transparent outline-none text-right font-black text-brand-blue placeholder-slate-400" 
                          />
                          <span className="text-xs font-bold text-slate-400 ml-0.5">%</span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="flex items-center bg-white dark:bg-black/20 px-3 py-1 rounded-lg border border-slate-200 dark:border-white/5">
                          <input 
                              ...
                              onChange={(e) => updateAlloc('cash', e.target.value)} 
                              className="w-10 bg-transparent outline-none text-right font-black text-brand-green placeholder-slate-400" 
                          />
                          <span className="text-xs font-bold text-slate-400 ml-0.5">%</span>
                      </div>
                    </div>
